                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationList as specification>
                            <dl>
                                ...
                                <dd><a href="javascript:;" :class="{selected:isSelected('${specification.attributeName}','${item}')}" @click="selectSpecifcation('${specification.attributeName}','${item}')">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="#"  @click="addGoodsToCartList()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
